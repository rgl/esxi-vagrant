...
Download the [Free ESXi 7.0U3g (aka vSphere Hypervisor) iso file](https://www.vmware.com/go/get-free-esxi).
...
qemu-system-x86_64 \
  ...
  -drive if=ide,media=cdrom,file=VMware-VMvisor-Installer-7.0U3g-20328353.x86_64.iso
...
export VSPHERE_OS_ISO="[$GOVC_DATASTORE] iso/VMware-VMvisor-Installer-7.0U3g-20328353.x86_64.iso"
